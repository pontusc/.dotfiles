...
description: Generate or edit a project's AGENTS.md memory file. Use whenever asked to create, write, edit, update, or generate a AGENTS.md for any project.
---
...
Project-specific patterns OMP should follow:
...
Things that would surprise or trip up OMP or a new developer:
