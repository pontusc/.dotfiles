...
description: Generate or edit a project's AGENTS.md instruction file. Use when asked to create, write, edit, update, or generate AGENTS.md for a project.
---
...
5. **Existing AGENTS.md**: read if present, preserve user customizations
...
Project-specific patterns Codex should follow:
...
Things that would surprise or trip up Codex or a new developer:
...
Before presenting the AGENTS.md to the user:
